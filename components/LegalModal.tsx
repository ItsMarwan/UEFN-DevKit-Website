...
const PRIVACY_CONTENT = (
  <div className="space-y-8">
    ...
    <section>
      ...
      <p className="text-white/70 mb-3">
        This includes data generated by new and existing Discord bot features such as customer management,
        coupon administration, island analytics, session handling, Verse script uploads, and seller profile management.
      </p>
...
const TOS_CONTENT = (
  <div className="space-y-8">
    <div>
      ...
      <p className="text-white/50 text-sm">Last updated: 21 March 2026 · Effective immediately upon use of the bot.</p>
    </div>
    ...
    <section>
      ...
      <ul className="space-y-2 text-white/70 list-disc list-inside">
        ...
        <li>Using new features safely and responsibly, including admin command extensions, role sync, command audit log views, and improved fast lookup search</li>
      </ul>
      <p className="text-white/70">
